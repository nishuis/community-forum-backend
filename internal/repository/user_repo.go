...
func (ur *UserRepo) FindUserByUsername(ctx context.Context, username string) (*domain.User, error) {
...
func (ur *UserRepo) FindUserByEmail(ctx context.Context, email string) (*domain.User, error) {
	var user domain.User
...
func (ur *UserRepo) FindUserByUserId(ctx context.Context, userId int64) (*domain.User, error) {
	var user domain.User
